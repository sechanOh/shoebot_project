...
from ai_manipulation.utils.utils import TryExcept
from ai_manipulation.utils.utils.dataloaders import exif_transpose, letterbox
from ai_manipulation.utils.utils.general import (LOGGER, ROOT, Profile, check_requirements, check_suffix, check_version, colorstr,
                           increment_path, is_jupyter, make_divisible, non_max_suppression, scale_boxes, xywh2xyxy,
                           xyxy2xywh, yaml_load)
from ai_manipulation.utils.utils.torch_utils import copy_attr, smart_inference_mode
...
class DetectMultiBackend(nn.Module):
    ...
    def __init__(self, weights='yolov5s.pt', device=torch.device('cpu'), dnn=False, data=None, fp16=False, fuse=True):
        ...
        from ai_manipulation.utils.models.experimental import attempt_download, attempt_load  # scoped to avoid circular import
    ...
    def _model_type(p='path/to/model.pt'):
        ...
        from ai_manipulation.utils.export import export_formats
        from ai_manipulation.utils.utils.downloads import is_url
